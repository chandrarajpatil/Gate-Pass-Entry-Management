<%-- 
    ...
    Created on : 18-Apr-2024, 8:58:22 pm
    Author     : LENOVO
--%>
            ...
            <div class="card-body p-5 text-center" style="background-color: #7FC7D9;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                          ...
                          style="color:yellow">Delete Employee</a>
                        </li>
                        <li class="nav-item">
              ...
              <div class="form-outline2 mb-4">
                ...
                <%
                    ...
                    if(x>0)
                    {
                        out.println("<h3>Record deleted successfully</h4>");
                    }
                    else
                    {
                        out.println("<h5>Unable to delete data</h5>");
                    }
                }
                    catch(Exception e)
                    {
