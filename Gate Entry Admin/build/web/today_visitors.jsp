<%-- 
    Document   : today_visitors
    Created on : 28-Apr-2024, 4:21:33 pm
    Author     : LENOVO
--%>
          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center" style="background-color: #7FC7D9;">
              ...
              <div class="form-outline3 mb-4">
                <br>
                <h3>Today's Visitors of Yashaswi Bhavan</h3>
                <br>
                ...
                <%
                    ...
                    ps = con.prepareStatement("SELECT V.VID, V.name, V.address, V.phone,v.id_type, V.gov_id, V.email, V.purpose, V.EID, E.name, V.date_, V.timein,V.timeout,V.time_difference from visitors V INNER JOIN employee E on V.EID = E.EID WHERE V.date_ = ?;");
                    ps.setString(1,date);
                    ResultSet rs = ps.executeQuery();
                    
                    if(rs.next()==false)
                    {
                    out.println("<h4>No Visitors visited Today");
                }
                else
                {
                ...
                <h4>Today's Visitor's Count <%=count%></h4>
                <%
                }
                %>
