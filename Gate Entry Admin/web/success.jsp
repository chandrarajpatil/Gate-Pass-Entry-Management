<%-- 
    Document   : success
    Created on : 04-May-2024, 3:59:01 pm
    Author     : LENOVO
--%>
            ...
            <div class="card-body p-5 text-center" style="background-color: #7FC7D9;">
              ...
              <div class="form-outline2 mb-4">
                ...
                <%
                    ...
                    ps = con.prepareStatement("UPDATE employee SET name = ?, phone = ?, email = ? WHERE EID = ?");
                    ps.setString(1, name);
                    ...
                    {
                        %>
                        <h4><span style="color:green">Record Updated Successfully</span></h4>
                    <%}
