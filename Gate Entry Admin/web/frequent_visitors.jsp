<%-- 
    Document   : frequent_visitor
    Created on : 28-Apr-2024, 4:06:44 pm
    Author     : LENOVO
--%>
          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center" style="background-color: #7FC7D9;">
              ...
              <div class="form-outline3 mb-4">
                <br>
                <h3>Frequent Visitors of Yashaswi Bhavan</h3>
                <br>
                ...
                <%
                    ...
                    String sql = "SELECT VID, name, address, phone,id_type,gov_id, email, purpose, COUNT(*) AS visit_count " +
                         "FROM visitors " +
                         "GROUP BY name " +
                   ...
                   Statement stmt = con.createStatement();
                    ...
                    if(rs.next()==false)
                    {
                    out.println("<h4>No Frequent Visitors");
                }
                else
                {
                ...
                <h4>Total Frequent Visitors: <%=count%></h4>
                <%
                }
                %>
