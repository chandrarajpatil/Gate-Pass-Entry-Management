<%-- 
    Document   : today_emp
    Created on : 29-Apr-2024, 12:29:25 pm
    Author     : LENOVO
--%>
          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center" style="background-color: #7FC7D9;">
              ...
              <div class="form-outline3 mb-4">
                <br>
                <h3>Attendance of Today's Employees of Yashaswi Bhavan</h3>
                <br>
                ...
                <%
                    ...
                    ps1=con.prepareStatement("UPDATE entry_exit SET time_difference = TIMEDIFF(timeout, timein), total_hours = HOUR(TIMEDIFF(timeout, timein));");
                    ps1.executeUpdate();
                    ps = con.prepareStatement("SELECT EX.EntryID, EX.EID, E.name, E.department, EX.date_, EX.timein, EX.timeout, EX.time_difference FROM entry_exit EX INNER JOIN employee E ON EX.EID = E.EID WHERE date_ = ?;");
                    ps.setString(1, date);
                    ...
                    if(rs.next()==false)
                    {
                    out.println("<h4>No Employee Present Today");
                }
                else
                {
                ...
                <h4>Total Employees Present : <%=count%></h4>
                <%
                }
                %>
